  ...
  try {
    if (fs.existsSync(settingsPath)) {
      ...
      settings.disabledMcpServers =
        settings.disabledMcpServers ?? defaultSettings.disabledMcpServers;
      ...
      settings.customCompletionUrl =
        settings.customCompletionUrl ?? defaultSettings.customCompletionUrl;
